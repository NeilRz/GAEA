...
import { DATASETS, findDataset } from "@/lib/attest";

// Datasets too large or too heavy for the serverless response path are also
...
export async function GET(
  ...
  if (Object.prototype.hasOwnProperty.call(STATIC_LARGE, id)) {
